<html>
  <head>
    ...
    <?php echo $__env->yieldContent('styleHead'); ?>
    <?php echo $__env->yieldContent('jsHead'); ?>
  </head>
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark d-flex fixed-top">
      ...
      <a class="navbar-brand ml-auto p-2" href="#">
        <?php echo $__env->yieldContent('titleProgram'); ?>
      </a>
    </nav> <!-- NOTE: END NAV -->
...
ab.Session.prototype.publish = function () {
 ...
 self._send(msg);
    ...
    <script>
    var conn = new ab.Session('ws://192.168.0.159:8080',
...
<?php /**PATH /home/as/Documentos/EPSEM-UPC/TFG/FINAL_CODE/AP1/FINAL_PROJECT_WEB/SERVER_WEB/RobotCarKit/resources/views/layouts/program.blade.php ENDPATH**/ ?>